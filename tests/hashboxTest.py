...
class TestStringMethods(test.TestCase):
    ...
    def testAlignConsciousScore(self):
        ...
        self.assertEqual(hb.getSimilarityExcludeAlignment("CCCAAACCC", "AAACCC", 3, "CCCAAACCC", "---AAACCC"), 1)
        ...
        self.assertEqual(hb.getSimilarityExcludeAlignment("CCGGTTAAA", "ACGGTAA", 2, "-CCGGTTAAA", "A-CGG-TA-A"), 1)
